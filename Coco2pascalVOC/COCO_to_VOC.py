...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_path',type = str ,help = 'path to json file.',default="/home/le.minh.chien/Desktop/anno_val.json")
    parser.add_argument('--output',type = str ,help = 'path to output xml files.',default="saved/")
